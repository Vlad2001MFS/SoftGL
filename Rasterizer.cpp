...
void drawTriangle(const Vec2i &bufferSize, bool isDepthTest, uint32_t depthFunc, const Vec2i &vpMin, const Vec2i &vpMax,
...
void processTriangles() {
    ...
    for (size_t i = 0; i < vertsCount; i += 3) {
        ...
        drawTriangle(bufferSize, isDepthTest, depthFunc, vpMin, vpMax, A, B, C);
    }
}
